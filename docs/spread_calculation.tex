...
The gate sits at $1.5$ rather than at the break-even $1.0$ deliberately:
$\kappa\epsb$ is a ratio of two noisy estimates, and a hard cut at the
theoretical break-even would stop quoting on estimation error alone.
\end{intuition}
