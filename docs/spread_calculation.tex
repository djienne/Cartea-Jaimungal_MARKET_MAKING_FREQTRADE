...
with Python worked examples\par}
...
\snip{scripts/mm_core.py}{471}{480}
\begin{lstlisting}
    if kappa_avg > 0:
...
\snip{scripts/mm_core.py}{631}{642}
\begin{lstlisting}
    n = len(axis)
...
\snip{scripts/mm_core.py}{659}{665}
\begin{lstlisting}
...
\snip{scripts/mm_core.py}{329}{343}
\begin{lstlisting}
...
\snip{scripts/mm_core.py}{372}{383}
\begin{lstlisting}
