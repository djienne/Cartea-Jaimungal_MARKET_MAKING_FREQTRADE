...
\snip{scripts/estimator_common.py}{735}{764}
\begin{lstlisting}
...
\snip{scripts/get_epsilon.py}{194}{202}
\begin{lstlisting}
    post = pd.merge_asof(
        frame,
...
\snip{scripts/estimator_common.py}{858}{864}
\begin{lstlisting}
...
\snip{scripts/mm_core.py}{468}{477}
\begin{lstlisting}
    if kappa_avg > 0:
...
\snip{scripts/mm_core.py}{628}{639}
\begin{lstlisting}
    n = len(axis)
...
\snip{scripts/mm_core.py}{656}{662}
\begin{lstlisting}
...
\snip{scripts/mm_core.py}{326}{340}
\begin{lstlisting}
...
\snip{scripts/mm_core.py}{88}{105}
\begin{lstlisting}
...
\snip{scripts/mm_core.py}{369}{380}
\begin{lstlisting}
