...
- PASS `compileall` (1.199s)
- PASS `pytest_core` (23.643s)
- PASS `config_safety_report` (0.107s)
- PASS `strategy_safety_report` (0.161s)
- PASS `compute_spreads_boundary_smoke` (1.544s)
- PASS `replay_smoke` (2.243s)
- PASS `post_only_probe_plan` (0.149s)
- PASS `post_only_evidence_report` (0.105s)
- PASS `direct_alo_adapter_plan` (0.135s)
- PASS `hyperliquid_fee_capture_plan` (0.103s)
- PASS `docker_compose_config` (0.274s)
- PASS `freqtrade_runtime_load` (8.28s)
- PASS `dry_run_disabled_smoke` (225.046s)
- PASS `dry_run_enabled_smoke` (313.63s)
- PASS `replay_log_calibration_artifact` (0.786s)
- PASS `fee_evidence_report` (0.081s)
- PASS `hl_data_validation_report` (1.388s)
- PASS `replay_latest_data_smoke` (3.155s)
- PASS `replay_acceptance_report_artifact` (15.684s)
- PASS `live_canary_evidence_report` (0.187s)

Post-run audits:
- PASS `plan_status_audit` (0.122s)
