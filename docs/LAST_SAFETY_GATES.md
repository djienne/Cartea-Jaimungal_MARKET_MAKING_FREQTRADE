...
- PASS `compileall` (1.185s)
- PASS `pytest_core` (23.522s)
- PASS `config_safety_report` (0.094s)
- PASS `strategy_safety_report` (0.141s)
- PASS `compute_spreads_boundary_smoke` (1.546s)
- PASS `replay_smoke` (1.845s)
- PASS `post_only_probe_plan` (0.111s)
- PASS `post_only_evidence_report` (0.088s)
- PASS `direct_alo_adapter_plan` (0.108s)
- PASS `hyperliquid_fee_capture_plan` (0.095s)
- PASS `docker_compose_config` (0.26s)
- PASS `freqtrade_runtime_load` (7.95s)
- PASS `dry_run_disabled_smoke` (225.438s)
- PASS `dry_run_enabled_smoke` (313.608s)
- PASS `replay_log_calibration_artifact` (0.889s)
- PASS `fee_evidence_report` (0.08s)
- PASS `hl_data_validation_report` (1.488s)
- PASS `replay_latest_data_smoke` (3.231s)
- PASS `replay_acceptance_report_artifact` (16.237s)
- PASS `live_canary_evidence_report` (0.115s)
