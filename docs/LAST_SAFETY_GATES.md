...
- PASS `compileall` (1.332s)
- PASS `pytest_core` (26.766s)
- PASS `config_safety_report` (0.068s)
- PASS `strategy_safety_report` (0.101s)
- PASS `compute_spreads_boundary_smoke` (1.436s)
- PASS `replay_smoke` (2.148s)
- PASS `post_only_probe_plan` (0.107s)
- PASS `post_only_evidence_report` (0.124s)
- PASS `direct_alo_adapter_plan` (0.172s)
- PASS `hyperliquid_fee_capture_plan` (0.117s)
- PASS `docker_compose_config` (0.274s)
- PASS `freqtrade_runtime_load` (7.765s)
- PASS `dry_run_disabled_smoke` (224.924s)
- PASS `dry_run_enabled_smoke` (313.992s)
- PASS `dry_run_quality_report` (0.116s)
- PASS `replay_log_calibration_artifact` (0.883s)
- PASS `fee_evidence_report` (0.113s)
- PASS `hl_data_validation_report` (1.543s)
- PASS `replay_latest_data_smoke` (3.614s)
- PASS `replay_acceptance_report_artifact` (16.652s)
- PASS `live_canary_evidence_report` (0.083s)

Post-run audits:
- PASS `plan_status_audit` (0.064s)
