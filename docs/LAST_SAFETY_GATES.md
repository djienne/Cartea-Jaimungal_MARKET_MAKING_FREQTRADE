...
- PASS `compileall` (1.486s)
- PASS `pytest_core` (26.897s)
- PASS `config_safety_report` (0.06s)
- PASS `strategy_safety_report` (0.105s)
- PASS `compute_spreads_boundary_smoke` (1.234s)
- PASS `replay_smoke` (1.57s)
- PASS `post_only_probe_plan` (0.065s)
- PASS `post_only_evidence_report` (0.058s)
- PASS `direct_alo_adapter_plan` (0.083s)
- PASS `direct_alo_probe_preparation_plan` (0.081s)
- PASS `direct_risk_flatten_plan` (0.085s)
- PASS `hyperliquid_fee_capture_plan` (0.064s)
- PASS `docker_compose_config` (0.114s)
- PASS `freqtrade_runtime_load` (5.264s)
- PASS `freqtrade_callback_surface` (6.11s)
- PASS `freqtrade_tif_runtime` (17.418s)
- PASS `dry_run_disabled_smoke` (223.995s)
- PASS `dry_run_enabled_smoke` (672.988s)
- PASS `dry_run_quality_report` (0.071s)
- PASS `replay_log_calibration_artifact` (0.514s)
- PASS `fee_evidence_report` (0.069s)
- PASS `hl_data_validation_report` (1.765s)
- PASS `replay_latest_data_smoke` (3.009s)
- PASS `replay_acceptance_report_artifact` (14.639s)
- PASS `live_canary_evidence_report` (0.101s)
- PASS `promotion_evidence_manifest` (0.077s)

Post-run audits:
- PASS `plan_status_audit` (0.074s)
