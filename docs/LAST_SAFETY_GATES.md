...
- PASS `compileall` (1.667s)
- PASS `pytest_core` (23.144s)
- PASS `config_safety_report` (0.06s)
- PASS `strategy_safety_report` (0.093s)
- PASS `compute_spreads_boundary_smoke` (1.295s)
- PASS `replay_smoke` (1.726s)
- PASS `post_only_probe_plan` (0.061s)
- PASS `post_only_evidence_report` (0.058s)
- PASS `direct_alo_adapter_plan` (0.076s)
- PASS `direct_risk_flatten_plan` (0.088s)
- PASS `hyperliquid_fee_capture_plan` (0.064s)
- PASS `docker_compose_config` (0.108s)
- PASS `freqtrade_runtime_load` (6.247s)
- PASS `freqtrade_callback_surface` (6.622s)
- PASS `freqtrade_tif_runtime` (17.155s)
- PASS `dry_run_disabled_smoke` (224.068s)
- PASS `dry_run_enabled_smoke` (1873.167s)
- PASS `dry_run_quality_report` (0.085s)
- PASS `replay_log_calibration_artifact` (0.941s)
- PASS `fee_evidence_report` (0.08s)
- PASS `hl_data_validation_report` (1.775s)
- PASS `replay_latest_data_smoke` (4.215s)
- PASS `replay_acceptance_report_artifact` (17.951s)
- PASS `live_canary_evidence_report` (0.104s)
- PASS `promotion_evidence_manifest` (0.07s)
