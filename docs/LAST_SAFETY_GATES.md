...
- PASS `compileall` (1.235s)
- PASS `pytest_core` (21.309s)
- PASS `config_safety_report` (0.077s)
- PASS `strategy_safety_report` (0.078s)
- PASS `compute_spreads_boundary_smoke` (1.282s)
- PASS `replay_smoke` (1.992s)
...
- PASS `freqtrade_runtime_load` (7.317s)
- PASS `dry_run_disabled_smoke` (224.682s)
- PASS `dry_run_enabled_smoke` (313.825s)
- PASS `replay_log_calibration_artifact` (0.758s)
- PASS `fee_evidence_report` (0.084s)
- PASS `hl_data_validation_report` (1.744s)
- PASS `replay_latest_data_smoke` (2.883s)
- PASS `replay_acceptance_report_artifact` (15.973s)
