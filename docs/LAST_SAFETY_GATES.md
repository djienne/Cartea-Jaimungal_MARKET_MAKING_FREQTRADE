...
- PASS `compileall` (1.083s)
- PASS `pytest_core` (25.355s)
- PASS `config_safety_report` (0.073s)
- PASS `strategy_safety_report` (0.187s)
- PASS `compute_spreads_boundary_smoke` (1.585s)
- PASS `replay_smoke` (1.938s)
- PASS `post_only_probe_plan` (0.117s)
- PASS `post_only_evidence_report` (0.117s)
- PASS `direct_alo_adapter_plan` (0.157s)
- PASS `direct_risk_flatten_plan` (0.154s)
- PASS `hyperliquid_fee_capture_plan` (0.109s)
- PASS `docker_compose_config` (0.229s)
- PASS `freqtrade_runtime_load` (8.28s)
- PASS `dry_run_disabled_smoke` (224.572s)
- PASS `dry_run_enabled_smoke` (313.696s)
- PASS `dry_run_quality_report` (0.075s)
- PASS `replay_log_calibration_artifact` (0.817s)
- PASS `fee_evidence_report` (0.115s)
- PASS `hl_data_validation_report` (1.957s)
- PASS `replay_latest_data_smoke` (3.458s)
- PASS `replay_acceptance_report_artifact` (16.482s)
- PASS `live_canary_evidence_report` (0.089s)
