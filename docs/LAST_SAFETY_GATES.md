...
- PASS `pytest_core` (22.549s)
- PASS `config_safety_report` (0.068s)
- PASS `strategy_safety_report` (0.081s)
- PASS `compute_spreads_boundary_smoke` (1.457s)
- PASS `replay_smoke` (1.832s)
- PASS `post_only_probe_plan` (0.089s)
- PASS `post_only_evidence_report` (0.088s)
- PASS `direct_alo_adapter_plan` (0.113s)
- PASS `hyperliquid_fee_capture_plan` (0.11s)
- PASS `docker_compose_config` (0.216s)
- PASS `freqtrade_runtime_load` (7.484s)
- PASS `dry_run_disabled_smoke` (224.687s)
- PASS `dry_run_enabled_smoke` (314.186s)
- PASS `replay_log_calibration_artifact` (0.787s)
- PASS `fee_evidence_report` (0.115s)
- PASS `hl_data_validation_report` (1.391s)
- PASS `replay_latest_data_smoke` (3.449s)
- PASS `replay_acceptance_report_artifact` (16.131s)
- PASS `live_canary_evidence_report` (0.155s)

Post-run audits:
- PASS `plan_status_audit` (0.107s)
