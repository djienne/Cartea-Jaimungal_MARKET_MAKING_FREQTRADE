...
- PASS `compileall` (1.03s)
- PASS `pytest_core` (25.497s)
- PASS `config_safety_report` (0.12s)
- PASS `strategy_safety_report` (0.134s)
- PASS `compute_spreads_boundary_smoke` (1.497s)
- PASS `replay_smoke` (2.154s)
- PASS `post_only_probe_plan` (0.114s)
- PASS `post_only_evidence_report` (0.126s)
- PASS `direct_alo_adapter_plan` (0.149s)
- PASS `hyperliquid_fee_capture_plan` (0.12s)
- PASS `docker_compose_config` (0.296s)
- PASS `freqtrade_runtime_load` (8.581s)
- PASS `dry_run_disabled_smoke` (224.901s)
- PASS `dry_run_enabled_smoke` (313.719s)
- PASS `replay_log_calibration_artifact` (1.337s)
- PASS `fee_evidence_report` (0.102s)
- PASS `hl_data_validation_report` (2.206s)
- PASS `replay_latest_data_smoke` (3.719s)
- PASS `replay_acceptance_report_artifact` (16.888s)
- PASS `live_canary_evidence_report` (0.127s)

Post-run audits:
- PASS `plan_status_audit` (0.115s)
