...
- PASS `pytest_core` (23.969s)
- PASS `config_safety_report` (0.078s)
- PASS `strategy_safety_report` (0.101s)
- PASS `compute_spreads_boundary_smoke` (1.454s)
- PASS `replay_smoke` (1.799s)
- PASS `post_only_probe_plan` (0.124s)
- PASS `post_only_evidence_report` (0.111s)
- PASS `direct_alo_adapter_plan` (0.136s)
- PASS `docker_compose_config` (0.289s)
- PASS `freqtrade_runtime_load` (9.217s)
- PASS `dry_run_disabled_smoke` (230.762s)
- PASS `dry_run_enabled_smoke` (313.654s)
- PASS `replay_log_calibration_artifact` (1.855s)
- PASS `fee_evidence_report` (0.093s)
- PASS `hl_data_validation_report` (2.059s)
- PASS `replay_latest_data_smoke` (5.353s)
- PASS `replay_acceptance_report_artifact` (16.851s)
- PASS `live_canary_evidence_report` (0.18s)

Post-run audits:
- PASS `plan_status_audit` (0.134s)
