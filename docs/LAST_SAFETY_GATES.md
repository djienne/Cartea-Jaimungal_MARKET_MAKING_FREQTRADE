...
- PASS `compileall` (1.031s)
- PASS `pytest_core` (25.609s)
- PASS `config_safety_report` (0.061s)
- PASS `strategy_safety_report` (0.08s)
- PASS `compute_spreads_boundary_smoke` (1.453s)
- PASS `replay_smoke` (2.104s)
- PASS `post_only_probe_plan` (0.097s)
- PASS `post_only_evidence_report` (0.152s)
- PASS `direct_alo_adapter_plan` (0.126s)
- PASS `hyperliquid_fee_capture_plan` (0.107s)
- PASS `docker_compose_config` (0.31s)
- PASS `freqtrade_runtime_load` (8.521s)
- PASS `dry_run_disabled_smoke` (225.077s)
- PASS `dry_run_enabled_smoke` (313.833s)
- PASS `replay_log_calibration_artifact` (0.826s)
- PASS `fee_evidence_report` (0.128s)
- PASS `hl_data_validation_report` (1.56s)
- PASS `replay_latest_data_smoke` (3.118s)
- PASS `replay_acceptance_report_artifact` (15.418s)
