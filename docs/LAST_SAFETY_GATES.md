...
- PASS `compileall` (1.217s)
- PASS `pytest_core` (24.806s)
- PASS `config_safety_report` (0.089s)
- PASS `strategy_safety_report` (0.136s)
- PASS `compute_spreads_boundary_smoke` (1.524s)
- PASS `replay_smoke` (2.129s)
...
- PASS `docker_compose_config` (0.288s)
- PASS `freqtrade_runtime_load` (7.72s)
- PASS `dry_run_disabled_smoke` (224.905s)
- PASS `dry_run_enabled_smoke` (314.153s)
- PASS `replay_log_calibration_artifact` (0.888s)
- PASS `fee_evidence_report` (0.128s)
- PASS `hl_data_validation_report` (1.591s)
- PASS `replay_latest_data_smoke` (3.236s)
- PASS `replay_acceptance_report_artifact` (16.376s)
- PASS `live_canary_evidence_report` (0.205s)
