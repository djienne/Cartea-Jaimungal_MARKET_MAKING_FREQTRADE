...
- PASS `compileall` (1.222s)
- PASS `pytest_core` (25.522s)
- PASS `config_safety_report` (0.09s)
- PASS `strategy_safety_report` (0.132s)
- PASS `compute_spreads_boundary_smoke` (1.328s)
- PASS `replay_smoke` (1.829s)
...
- PASS `docker_compose_config` (0.2s)
- PASS `freqtrade_runtime_load` (7.638s)
- PASS `dry_run_disabled_smoke` (224.658s)
- PASS `dry_run_enabled_smoke` (314.031s)
- PASS `replay_log_calibration_artifact` (1.067s)
- PASS `fee_evidence_report` (0.158s)
- PASS `hl_data_validation_report` (1.984s)
- PASS `replay_latest_data_smoke` (3.889s)
- PASS `replay_acceptance_report_artifact` (17.597s)
- PASS `live_canary_evidence_report` (0.134s)
