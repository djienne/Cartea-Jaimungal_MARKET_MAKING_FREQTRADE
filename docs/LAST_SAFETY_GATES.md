...
- PASS `compileall` (1.065s)
- PASS `pytest_core` (24.929s)
- PASS `config_safety_report` (0.059s)
- PASS `strategy_safety_report` (0.078s)
- PASS `compute_spreads_boundary_smoke` (1.326s)
- PASS `replay_smoke` (2.143s)
- PASS `post_only_probe_plan` (0.105s)
- PASS `post_only_evidence_report` (0.094s)
- PASS `direct_alo_adapter_plan` (0.116s)
- PASS `hyperliquid_fee_capture_plan` (0.09s)
- PASS `docker_compose_config` (0.262s)
- PASS `freqtrade_runtime_load` (7.463s)
- PASS `dry_run_disabled_smoke` (225.1s)
- PASS `dry_run_enabled_smoke` (313.629s)
- PASS `replay_log_calibration_artifact` (0.743s)
- PASS `fee_evidence_report` (0.133s)
- PASS `hl_data_validation_report` (1.759s)
- PASS `replay_latest_data_smoke` (3.436s)
- PASS `replay_acceptance_report_artifact` (16.695s)
- PASS `live_canary_evidence_report` (0.196s)

Post-run audits:
- PASS `plan_status_audit` (0.088s)
