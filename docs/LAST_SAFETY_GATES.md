...
- PASS `compileall` (1.096s)
- PASS `pytest_core` (23.53s)
- PASS `config_safety_report` (0.071s)
- PASS `strategy_safety_report` (0.145s)
- PASS `compute_spreads_boundary_smoke` (1.758s)
- PASS `replay_smoke` (1.872s)
- PASS `post_only_probe_plan` (0.117s)
- PASS `post_only_evidence_report` (0.111s)
- PASS `direct_alo_adapter_plan` (0.143s)
- PASS `hyperliquid_fee_capture_plan` (0.121s)
- PASS `docker_compose_config` (0.208s)
- PASS `freqtrade_runtime_load` (7.533s)
- PASS `dry_run_disabled_smoke` (224.602s)
- PASS `dry_run_enabled_smoke` (313.109s)
- PASS `replay_log_calibration_artifact` (0.827s)
- PASS `fee_evidence_report` (0.135s)
- PASS `hl_data_validation_report` (1.95s)
- PASS `replay_latest_data_smoke` (2.971s)
- PASS `replay_acceptance_report_artifact` (16.163s)
- PASS `live_canary_evidence_report` (0.121s)
