...
- PASS `strategy_safety_report` (0.077s)
- PASS `compute_spreads_boundary_smoke` (1.406s)
- PASS `replay_smoke` (1.815s)
...
- PASS `freqtrade_runtime_load` (7.6s)
- PASS `dry_run_disabled_smoke` (224.314s)
- PASS `dry_run_enabled_smoke` (313.955s)
- PASS `replay_log_calibration_artifact` (0.731s)
- PASS `fee_evidence_report` (0.125s)
- PASS `hl_data_validation_report` (1.847s)
- PASS `replay_latest_data_smoke` (3.87s)
- PASS `replay_acceptance_report_artifact` (17.406s)
- PASS `live_canary_evidence_report` (0.152s)
