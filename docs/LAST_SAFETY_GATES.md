...
- PASS `compileall` (1.295s)
- PASS `pytest_core` (27.343s)
- PASS `config_safety_report` (0.092s)
- PASS `strategy_safety_report` (0.136s)
- PASS `compute_spreads_boundary_smoke` (1.7s)
- PASS `replay_smoke` (2.246s)
- PASS `post_only_probe_plan` (0.095s)
- PASS `post_only_evidence_report` (0.088s)
- PASS `direct_alo_adapter_plan` (0.131s)
- PASS `hyperliquid_fee_capture_plan` (0.111s)
- PASS `docker_compose_config` (0.254s)
- PASS `freqtrade_runtime_load` (7.865s)
- PASS `dry_run_disabled_smoke` (224.665s)
- PASS `dry_run_enabled_smoke` (313.719s)
- PASS `dry_run_quality_report` (0.116s)
- PASS `replay_log_calibration_artifact` (0.646s)
- PASS `fee_evidence_report` (0.065s)
- PASS `hl_data_validation_report` (1.853s)
- PASS `replay_latest_data_smoke` (3.399s)
- PASS `replay_acceptance_report_artifact` (16.775s)
- PASS `live_canary_evidence_report` (0.141s)

Post-run audits:
- PASS `plan_status_audit` (0.118s)
