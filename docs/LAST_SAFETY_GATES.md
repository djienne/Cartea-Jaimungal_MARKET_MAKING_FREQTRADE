...
- PASS `compileall` (0.91s)
- PASS `pytest_core` (23.165s)
- PASS `config_safety_report` (0.065s)
- PASS `strategy_safety_report` (0.107s)
- PASS `compute_spreads_boundary_smoke` (1.555s)
- PASS `replay_smoke` (1.795s)
- PASS `post_only_probe_plan` (0.092s)
- PASS `post_only_evidence_report` (0.108s)
- PASS `direct_alo_adapter_plan` (0.107s)
- PASS `hyperliquid_fee_capture_plan` (0.124s)
- PASS `docker_compose_config` (0.248s)
- PASS `freqtrade_runtime_load` (7.557s)
- PASS `dry_run_disabled_smoke` (224.529s)
- PASS `dry_run_enabled_smoke` (313.66s)
- PASS `replay_log_calibration_artifact` (0.716s)
- PASS `fee_evidence_report` (0.133s)
- PASS `hl_data_validation_report` (1.882s)
- PASS `replay_latest_data_smoke` (3.435s)
- PASS `replay_acceptance_report_artifact` (16.244s)
- PASS `live_canary_evidence_report` (0.188s)

Post-run audits:
- PASS `plan_status_audit` (0.111s)
