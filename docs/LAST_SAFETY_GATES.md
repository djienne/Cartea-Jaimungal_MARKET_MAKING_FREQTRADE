...
- PASS `pytest_core` (23.648s)
- PASS `config_safety_report` (0.088s)
- PASS `strategy_safety_report` (0.118s)
- PASS `compute_spreads_boundary_smoke` (1.347s)
- PASS `replay_smoke` (1.918s)
- PASS `post_only_probe_plan` (0.063s)
- PASS `post_only_evidence_report` (0.099s)
- PASS `direct_alo_adapter_plan` (0.123s)
- PASS `docker_compose_config` (0.28s)
- PASS `freqtrade_runtime_load` (8.22s)
- PASS `dry_run_disabled_smoke` (224.76s)
- PASS `dry_run_enabled_smoke` (313.659s)
- PASS `replay_log_calibration_artifact` (0.771s)
- PASS `fee_evidence_report` (0.134s)
- PASS `hl_data_validation_report` (1.646s)
- PASS `replay_latest_data_smoke` (3.279s)
- PASS `replay_acceptance_report_artifact` (16.575s)
- PASS `live_canary_evidence_report` (0.143s)

Post-run audits:
- PASS `plan_status_audit` (0.11s)
