...
- PASS `pytest_core` (24.026s)
- PASS `config_safety_report` (0.073s)
- PASS `strategy_safety_report` (0.095s)
- PASS `compute_spreads_boundary_smoke` (1.611s)
- PASS `replay_smoke` (2.101s)
- PASS `post_only_probe_plan` (0.105s)
- PASS `post_only_evidence_report` (0.114s)
- PASS `direct_alo_adapter_plan` (0.12s)
- PASS `hyperliquid_fee_capture_plan` (0.084s)
- PASS `docker_compose_config` (0.168s)
- PASS `freqtrade_runtime_load` (7.585s)
- PASS `dry_run_disabled_smoke` (224.808s)
- PASS `dry_run_enabled_smoke` (313.635s)
- PASS `replay_log_calibration_artifact` (0.723s)
- PASS `fee_evidence_report` (0.078s)
- PASS `hl_data_validation_report` (1.401s)
- PASS `replay_latest_data_smoke` (3.005s)
- PASS `replay_acceptance_report_artifact` (15.823s)
- PASS `live_canary_evidence_report` (0.422s)
