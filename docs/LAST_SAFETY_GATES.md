...
- PASS `compileall` (1.19s)
- PASS `pytest_core` (25.197s)
- PASS `config_safety_report` (0.094s)
- PASS `strategy_safety_report` (0.188s)
- PASS `compute_spreads_boundary_smoke` (1.623s)
- PASS `replay_smoke` (1.979s)
- PASS `post_only_probe_plan` (0.107s)
- PASS `post_only_evidence_report` (0.092s)
- PASS `direct_alo_adapter_plan` (0.08s)
- PASS `hyperliquid_fee_capture_plan` (0.066s)
- PASS `docker_compose_config` (0.167s)
- PASS `freqtrade_runtime_load` (8.081s)
- PASS `dry_run_disabled_smoke` (224.96s)
- PASS `dry_run_enabled_smoke` (313.856s)
- PASS `dry_run_quality_report` (0.1s)
- PASS `replay_log_calibration_artifact` (0.864s)
- PASS `fee_evidence_report` (0.107s)
- PASS `hl_data_validation_report` (1.874s)
- PASS `replay_latest_data_smoke` (3.374s)
- PASS `replay_acceptance_report_artifact` (17.086s)
- PASS `live_canary_evidence_report` (0.129s)

Post-run audits:
- PASS `plan_status_audit` (0.103s)
