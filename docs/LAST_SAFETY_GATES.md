...
- PASS `compileall` (1.077s)
- PASS `pytest_core` (27.839s)
- PASS `config_safety_report` (0.096s)
- PASS `strategy_safety_report` (0.151s)
- PASS `compute_spreads_boundary_smoke` (1.336s)
- PASS `replay_smoke` (1.877s)
- PASS `post_only_probe_plan` (0.07s)
- PASS `post_only_evidence_report` (0.088s)
- PASS `direct_alo_adapter_plan` (0.106s)
- PASS `hyperliquid_fee_capture_plan` (0.105s)
- PASS `docker_compose_config` (0.246s)
- PASS `freqtrade_runtime_load` (8.691s)
- PASS `dry_run_disabled_smoke` (224.808s)
- PASS `dry_run_enabled_smoke` (313.68s)
- PASS `dry_run_quality_report` (0.102s)
- PASS `replay_log_calibration_artifact` (0.755s)
- PASS `fee_evidence_report` (0.067s)
- PASS `hl_data_validation_report` (1.589s)
- PASS `replay_latest_data_smoke` (3.163s)
- PASS `replay_acceptance_report_artifact` (18.397s)
- PASS `live_canary_evidence_report` (0.111s)
